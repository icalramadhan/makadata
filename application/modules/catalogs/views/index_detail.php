...
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link d-flex align-items-center justify-content-between"><span>Men </span><span class="badge badge-secondary">42</span></a>';
echo '<ul class="nav nav-pills flex-column">';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">T-shirts</a></li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">Shirts</a></li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">Pants</a></li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">Accessories</a></li>';
echo '</ul>';
echo '</li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link active d-flex align-items-center justify-content-between"><span>Ladies  </span><span class="badge badge-light">123</span></a>';
echo '<ul class="nav nav-pills flex-column">';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">T-shirts</a></li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">Skirts</a></li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">Pants</a></li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">Accessories</a></li>';
echo '</ul>';
echo '</li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link d-flex align-items-center justify-content-between"><span>Kids  </span><span class="badge badge-secondary">11</span></a>';
echo '<ul class="nav nav-pills flex-column">';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">T-shirts</a></li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">Skirts</a></li>';
echo '<li class="nav-item"><a href="shop-category.html" class="nav-link">Pants</a></li>';
