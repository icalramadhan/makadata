...
echo '<div class="left-col"><a href="' . base_url() . 'order/payment" class="btn btn-template-outlined"><i class="fa fa-chevron-left"></i> Proceed To CheckOut</a></div>';
echo '<div class="right-col">';
if(!empty($cart)) {
echo '<a href="'. base_url() . 'order/payment"  class="btn btn-template-outlined">Place The Order <i class="fa fa-chevron-right"></i></a>';
}
echo '</div>';
echo '</div>';
echo '</div>';
